...
var coordFetch = function(cityName) {
  fetch("https://api.openweathermap.org/data/2.5/weather?q=" + cityName + "&units=imperial&appid=901cf7cbff8bb5833673e9e75c4516a6")
...
var weatherFetch = function(lat, lon, cityName) {
  fetch("https://api.openweathermap.org/data/2.5/onecall?lat=" + lat + "&lon=" + lon + "&units=imperial&appid=901cf7cbff8bb5833673e9e75c4516a6")
    .then(function(response) {
      if (response.ok) {
        response.json().then(function(data) {
          console.log(data);
...
initializeListeners();
//api key
//901cf7cbff8bb5833673e9e75c4516a6
